...
public class ScamOMeter {
    ...
    private static final Logger SCAMOMETER_LOGGER = Loggers.getLogger("scam-o-meter");
     ...
     */
    public static void sendSecurityAuditLog(MessageCreateEvent event) {
        try {
            ...
            SCAMOMETER_LOGGER.error("An error occurred", e);
        }
    }
}
